...
require 'roodi/checks/duplicate_tests_check'
require 'roodi/checks/incomplete_initialize_check'
require 'roodi/checks/print_check'
require 'roodi/checks/missing_responds_to_check'
